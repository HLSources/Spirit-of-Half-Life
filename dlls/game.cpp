...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	// Bullsquid
	CVAR_REGISTER ( &sk_bullsquid_health1 );// {"sk_otis_health1","0"};
	CVAR_REGISTER ( &sk_bullsquid_health2 );// {"sk_otis_health2","0"};
	CVAR_REGISTER ( &sk_bullsquid_health3 );// {"sk_otis_health3","0"};
